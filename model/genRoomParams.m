function [param,n] = genRoomParams(vecNeighbors, area, H, flag, insulationsTable, coefficients, eq)
...
for i = 2:size(vecNeighbors,2)
    W = vecNeighbors(1,i); %długość sciany wewnętrznej sąsiedniczącej z sekcją
