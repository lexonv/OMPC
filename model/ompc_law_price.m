function [u, c] = ompc_law_price(A,B,C,K,Sxc,Sc,Scr,zoneWaterIndex,umax,umin,xmax,xmin,ymax,ymin,w,nc,npred,price,ref,dist,x)
...
[CC, d, dd] = ompc_constraints(Px, Py, Pu, Hxc, Hyc, Huc, Qrx, Qry, Qru, npred,umax, umin, xmax, xmin, ymax, ymin, zoneWaterIndex, nx, x, ref, dist);
