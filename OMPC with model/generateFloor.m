...
if is_unheated == 1
    ...
    is_controlled = 0;
    [param,n] = genRoomParams(vecNeighbors(2,:), vecArea(1,2), H, floorType, insulations, coefficients, eq);
...
for i = 3:size(vecNeighbors,2)
    eq = equipment(:,m); m = m+1;
    is_controlled = 1;
    [param,n] = genRoomParams(vecNeighbors(i,:), vecArea(1,i), H, floorType, insulations, coefficients, eq);
